        ...
        <office:document-content 
            ...
            <office:body>
                <office:text>
                    ...
                    <text:p text:style-name="P7">Course Evaluation Academic Year Final Report</text:p>
                    ...
                    <text:p text:style-name="P16">
                        <text:span text:style-name="T5">Academic Year Final Report <xsl:value-of select="studiengang_kurz" /> - <xsl:value-of select="studienjahr" /></text:span>
                    </text:p>
                    ...
                    <table:table table:name="Tabelle1" table:style-name="Tabelle1">
                        ...
                        <table:table-row>
                            <table:table-cell table:style-name="Tabelle1.A1" office:value-type="string">
                                <text:p text:style-name="P17">Degree-Program</text:p>
                            </table:table-cell>
                            <table:table-cell table:style-name="Tabelle1.B1" office:value-type="string">
                                <text:p text:style-name="P21"><xsl:value-of select="studiengang_lang_eng" /></text:p>
                            </table:table-cell>
                        </table:table-row>
                        <table:table-row>
                            <table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
                                <text:p text:style-name="P17">Academic year</text:p>
                            </table:table-cell>
                    ...
                    <table:table table:name="Tabelle2" table:style-name="Tabelle2">
                        ...
                        <table:table-row>
                            <table:table-cell table:style-name="Tabelle2.A1" office:value-type="string">
                                <text:p text:style-name="P17">Courses evaluated</text:p>
                            </table:table-cell>
                            <table:table-cell table:style-name="Tabelle2.B1" office:value-type="string">
                                <text:p text:style-name="P21">Organisational form</text:p>
                            </table:table-cell>
                        </table:table-row>
                    ...
                    <table:table table:name="Tabelle3" table:style-name="Tabelle3">
                        ...
                        <table:table-row>
                            <table:table-cell table:style-name="Tabelle3.A1" office:value-type="string">
                                <text:p text:style-name="P15">What results have been achieved?</text:p>
                            </table:table-cell>
                        </table:table-row>
                        <table:table-row>
                    ...
                    <table:table table:name="Tabelle4" table:style-name="Tabelle4">
                        ...
                        <table:table-row>
                            <table:table-cell table:style-name="Tabelle4.A1" office:value-type="string">
                                <text:p text:style-name="P15">What improvments have been made?</text:p>
                            </table:table-cell>
                        </table:table-row>
                        <table:table-row>
