		...
		<office:document-content 
			...
			<office:body>
				<office:text text:use-soft-page-breaks="true">
					...
					<text:p text:style-name="P20">Academic Year Final Report <xsl:value-of select="studiengang_kurz" /> - <xsl:value-of select="studienjahr" /></text:p>
					...
					<table:table table:name="Tabelle1" table:style-name="Tabelle1">
						...
						<table:table-row>
							<table:table-cell table:style-name="Tabelle1.A1" office:value-type="string">
								<text:p text:style-name="P15">Degree-Program</text:p>
							</table:table-cell>
						...
						<table:table-row>
							<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
								<text:p text:style-name="P15">Academic year</text:p>
							</table:table-cell>
						...
						<table:table-row>
							<table:table-cell table:style-name="Tabelle1.A3" office:value-type="string">
								<text:p text:style-name="P16">Amount of courses evaluated</text:p>
							</table:table-cell>
							<table:table-cell table:style-name="Tabelle1.B2" office:value-type="string">
								<text:p text:style-name="P18"><xsl:value-of select="anzahl_evaluierte_lvs" /> out of <xsl:value-of select="anzahl_lvs" /> courses were evaluated.</text:p>
							</table:table-cell>
						</table:table-row>
						<table:table-row>
							<table:table-cell table:style-name="Tabelle1.A4" office:value-type="string">
								<text:p text:style-name="P16">Evaluation quote</text:p>
							</table:table-cell>
							<table:table-cell table:style-name="Tabelle1.B2" office:value-type="string">
		...
		<xsl:if test="evaluierte_lvs = ''"> 
			<table:table-row>
				<table:table-cell table:style-name="Tabelle2.A2" office:value-type="string">
					<text:p text:style-name="P16">No courses were evaluated this academic year.</text:p>
				</table:table-cell>
			</table:table-row>
		</xsl:if>
	</xsl:template>
