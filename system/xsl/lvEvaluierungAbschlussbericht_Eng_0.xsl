		...
		<style:style style:name="P20" style:family="paragraph" style:parent-style-name="Table_20_Contents">
			...
			<office:body>
				<office:text text:use-soft-page-breaks="true">
					...
					<text:p text:style-name="P13">Course Evaluation Academic Year Final Report</text:p>
					<text:p text:style-name="P5"/>
					<text:p text:style-name="P9"/>
					<text:p text:style-name="P3"/>
					<text:p text:style-name="P11"/>
					<text:p text:style-name="P14"/>
					<text:p text:style-name="P15">Academic Year Final Report <xsl:value-of select="studiengang_kurz" /> - <xsl:value-of select="studienjahr" /></text:p>
					...
					<table:table table:name="Tabelle1" table:style-name="Tabelle1">
						...
						<table:table-row>
							<table:table-cell table:style-name="Tabelle1.A1" office:value-type="string">
								<text:p text:style-name="P16">Degree-Program</text:p>
							</table:table-cell>
						...
						<table:table-row>
							<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
								<text:p text:style-name="P16">Academic year</text:p>
							</table:table-cell>
						...
						<table:table-row>
							<table:table-cell table:style-name="Tabelle1.A3" office:value-type="string">
								<text:p text:style-name="P18">Amount of courses evaluated</text:p>
							</table:table-cell>
							<table:table-cell table:style-name="Tabelle1.B2" office:value-type="string">
								<text:p text:style-name="P20"><xsl:value-of select="anzahl_evaluierte_lvs" /> out of <xsl:value-of select="anzahl_lvs" /> courses were evaluated.</text:p>
							</table:table-cell>
						</table:table-row>
						<table:table-row>
							<table:table-cell table:style-name="Tabelle1.A4" office:value-type="string">
								<text:p text:style-name="P18">Evaluation quote</text:p>
							</table:table-cell>
							<table:table-cell table:style-name="Tabelle1.B2" office:value-type="string">
					...
					<table:table table:name="Tabelle3" table:style-name="Tabelle3">
						...
						<table:table-row>
							<table:table-cell table:style-name="Tabelle3.A1" office:value-type="string">
								<text:p text:style-name="P10">What results have been achieved?</text:p>
							</table:table-cell>
						</table:table-row>
					...
					<table:table table:name="Tabelle4" table:style-name="Tabelle4">
						...
						<table:table-row>
							<table:table-cell table:style-name="Tabelle4.A1" office:value-type="string">
								<text:p text:style-name="P10">What improvements have been made?</text:p>
							</table:table-cell>
						</table:table-row>
						<table:table-row>
		...
		<table:table-row>
			<table:table-cell table:style-name="Tabelle2.A1" office:value-type="string">
				<text:p text:style-name="P17">
					<text:span text:style-name="T3">Courses evaluated </text:span>  <xsl:value-of select="org_form" /></text:p>
			</table:table-cell>
			<table:table-cell table:style-name="Tabelle2.B1" office:value-type="string">
						<text:p text:style-name="P22">Educational semester</text:p>
			</table:table-cell>
		</table:table-row>
		...
		<xsl:if test="evaluierte_lvs = ''"> 
			<table:table-row>
				<table:table-cell table:style-name="Tabelle2.A2" office:value-type="string">
					<text:p text:style-name="P18">No courses were evaluated this academic year.</text:p>
				</table:table-cell>
